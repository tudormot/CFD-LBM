...
int readParameters(dimensions * dim, double *tau_f, double *tau_g, double *velocityWall, unsigned int *timesteps, unsigned int *timestepsPerPlotting, int argc, char *argv[],char *filename){
