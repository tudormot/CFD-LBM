...
void computePostCollisionDistribution(double *currentCell_f, double *currentCell_g, const double * const tau_f, const double * const, tau_g, const double *const feq){
